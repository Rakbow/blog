this.primevue = this.primevue || {}, this.primevue.menu = function (e, t, i, n, l) {
    "use strict";
    ...
    var o = s(t), r = s(i), a = s(l), c = {
        ...
        methods: {
            ...
            }, disabled: e => "function" == typeof e.disabled ? e.disabled() : e.disabled, label() {
                return "function" == typeof this.item.label ? this.item.label() : this.item.label
            }
        },
        computed: {
            containerClass() {
        ...
        directives: {ripple: r.default}
    };
    const m = ["href", "onClick"], d = {class: "p-menuitem-text"}, u = ["href", "target", "tabindex"],
        p = {class: "p-menuitem-text"};
    c.render = function (e, t, i, l, s, o) {
        const r = n.resolveComponent("router-link"), a = n.resolveDirective("ripple");
        return o.visible() ? (n.openBlock(), n.createElementBlock("li", {
            key: 0,
            class: n.normalizeClass(o.containerClass),
            role: "none",
            style: n.normalizeStyle(i.item.style)
        }, [i.template ? (n.openBlock(), n.createBlock(n.resolveDynamicComponent(i.template), {
            key: 1,
            item: i.item
        }, null, 8, ["item"])) : (n.openBlock(), n.createElementBlock(n.Fragment, {key: 0}, [i.item.to && !o.disabled(i.item) ? (n.openBlock(), n.createBlock(r, {
            key: 0,
            to: i.item.to,
            custom: ""
        }, {
            default: n.withCtx((({
                                     ...
                                     isActive: l,
                                     isExactActive: s
                                 }) => [n.withDirectives((n.openBlock(), n.createElementBlock("a", {
                href: t,
                onClick: t => o.onClick(t, e),
                class: n.normalizeClass(o.linkClass(i.item, {isActive: l, isExactActive: s})),
                role: "menuitem"
            }, [i.item.icon ? (n.openBlock(), n.createElementBlock("span", {
                key: 0,
                class: n.normalizeClass(["p-menuitem-icon", i.item.icon])
            }, null, 2)) : n.createCommentVNode("", !0), n.createElementVNode("span", d, n.toDisplayString(o.label()), 1)], 10, m)), [[a]])])),
            _: 1
        }, 8, ["to"])) : n.withDirectives((n.openBlock(), n.createElementBlock("a", {
            key: 1,
            href: i.item.url,
            class: n.normalizeClass(o.linkClass(i.item)),
            onClick: t[0] || (t[0] = (...e) => o.onClick && o.onClick(...e)),
            target: i.item.target,
            role: "menuitem",
            tabindex: o.disabled(i.item) ? null : "0"
        }, [i.item.icon ? (n.openBlock(), n.createElementBlock("span", {
            key: 0,
            class: n.normalizeClass(["p-menuitem-icon", i.item.icon])
        }, null, 2)) : n.createCommentVNode("", !0), n.createElementVNode("span", p, n.toDisplayString(o.label()), 1)], 10, u)), [[a]])], 64))], 6)) : n.createCommentVNode("", !0)
    };
    var h = {
        name: "Menu",
        inheritAttrs: !1,
        ...
        methods: {
            itemClick(e) {
                const t = e.item;
                this.disabled(t) || (t.command && t.command(e), t.to && e.navigate && e.navigate(e.originalEvent), this.hide())
            },
            toggle(e) {
            ...
            onOverlayClick(e) {
                o.default.emit("overlay-click", {originalEvent: e, target: this.target})
            }
        },
        computed: {
            containerClass() {
        ...
        components: {Menuitem: c, Portal: a.default}
    };
    const k = {class: "p-menu-list p-reset", role: "menu"}, v = {key: 0, class: "p-submenu-header"};
    return function (e, t) {
        void 0 === t && (t = {});
        var i = t.insertAt;
    ...
    }("\n.p-menu-overlay {\n    position: absolute;\n    top: 0;\n    left: 0;\n}\n.p-menu ul {\n    margin: 0;\n    padding: 0;\n    list-style: none;\n}\n.p-menu .p-menuitem-link {\n    cursor: pointer;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    text-decoration: none;\n    overflow: hidden;\n    position: relative;\n}\n.p-menu .p-menuitem-text {\n    line-height: 1;\n}\n"), h.render = function (e, t, i, l, s, o) {
        const r = n.resolveComponent("Menuitem"), a = n.resolveComponent("Portal");
        return n.openBlock(), n.createBlock(a, {appendTo: i.appendTo, disabled: !i.popup}, {
            default: n.withCtx((() => [n.createVNode(n.Transition, {
                ...
                default: n.withCtx((() => [!i.popup || s.overlayVisible ? (n.openBlock(), n.createElementBlock("div", n.mergeProps({
                    key: 0,
                    ref: o.containerRef,
                    class: o.containerClass
                }, e.$attrs, {onClick: t[0] || (t[0] = (...e) => o.onOverlayClick && o.onOverlayClick(...e))}), [n.createElementVNode("ul", k, [(n.openBlock(!0), n.createElementBlock(n.Fragment, null, n.renderList(i.model, ((t, l) => (n.openBlock(), n.createElementBlock(n.Fragment, {key: o.label(t) + l.toString()}, [t.items && o.visible(t) && !t.separator ? (n.openBlock(), n.createElementBlock(n.Fragment, {key: 0}, [t.items ? (n.openBlock(), n.createElementBlock("li", v, [n.renderSlot(e.$slots, "item", {item: t}, (() => [n.createTextVNode(n.toDisplayString(o.label(t)), 1)]))])) : n.createCommentVNode("", !0), (n.openBlock(!0), n.createElementBlock(n.Fragment, null, n.renderList(t.items, ((t, s) => (n.openBlock(), n.createElementBlock(n.Fragment, {key: t.label + l + s}, [o.visible(t) && !t.separator ? (n.openBlock(), n.createBlock(r, {
                    key: 0,
                    item: t,
                    onClick: o.itemClick,
                    template: e.$slots.item,
                    exact: i.exact
                }, null, 8, ["item", "onClick", "template", "exact"])) : o.visible(t) && t.separator ? (n.openBlock(), n.createElementBlock("li", {
                    key: "separator" + l + s,
                    class: n.normalizeClass(["p-menu-separator", t.class]),
                    style: n.normalizeStyle(t.style),
                    role: "separator"
                }, null, 6)) : n.createCommentVNode("", !0)], 64)))), 128))], 64)) : o.visible(t) && t.separator ? (n.openBlock(), n.createElementBlock("li", {
                    key: "separator" + l.toString(),
                    class: n.normalizeClass(["p-menu-separator", t.class]),
                    style: n.normalizeStyle(t.style),
                    role: "separator"
                }, null, 6)) : (n.openBlock(), n.createBlock(r, {
                    key: o.label(t) + l.toString(),
                    item: t,
                    onClick: o.itemClick,
                    template: e.$slots.item,
                    exact: i.exact
                ...
                _: 3
            }, 8, ["onEnter", "onLeave", "onAfterLeave"])])), _: 3
        }, 8, ["appendTo", "disabled"])
    }, h
