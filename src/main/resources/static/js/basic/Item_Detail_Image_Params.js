const showImageEditDialog = (toast, dialog, itemImageInfo, detailInfo) => {
...
const imageEditPanel = {
    ...
    methods: {
        ...
        updateImage() {
            ...
            axiosPostRequest(updateImageUrl, json)
                .then(res => {
                    if (res.state === 1) {
        ...
        submitImages() {
            ...
            axiosRequest(insertImageUrl, formData)
                .then(res => {
                    if (res.state === 1) {
