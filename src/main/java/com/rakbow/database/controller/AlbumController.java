...
import com.rakbow.database.annotation.LoginRequired;
import com.rakbow.database.entity.Album;
import com.rakbow.database.service.util.common.ApiResult;
...
public class AlbumController {
    ...
    @Value("${database.path.upload}")
    private String uploadPath;

    @Value("${database.path.img}")
    private String imgPath;
    @Value("${database.path.domain}")
    ...
    public String insertAlbum(@RequestBody String json) {
        ...
        try {
            res.message = albumService.insertAlbum(albumService.json2Album(param));
    ...
    public String deleteAlbum(@RequestBody String json){
        ...
        try {
            ...
            res.message = ApiResultInfo.DELETE_DATA_SUCCESS;
            return JSON.toJSONString(res);
        }catch (Exception ex){
            res.state = 0;
            res.message = ex.getMessage();
