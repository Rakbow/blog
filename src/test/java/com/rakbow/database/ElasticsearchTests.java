...
import com.rakbow.database.service.ElasticsearchService;
...
public class ElasticsearchTests {
    ...
    public void  testInsert(){
        albumRepository.save(albumMapper.selectAlbumById(110));
        albumRepository.save(albumMapper.selectAlbumById(111));
        albumRepository.save(albumMapper.selectAlbumById(112));
    }
    ...
    public void test111() throws IOException, ParseException {
        elasticsearchService.searchAlbum("MAGES", 10).stream().forEach(i -> System.out.println(i));
    }
